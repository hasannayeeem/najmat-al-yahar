...
import logo_v2 from "../../Assest/images/logo-v2.jpg";
const Footer = () => {
  ...
  return (
    <footer className="lg:flex ">
      <div className="w-4/12 flex justify-between">
        ...
        <div className="w-2/12 bg-warning">
          <ul className="justify-evenly lg:flex-col flex-row  flex">
            <li className="hover:bg-red-700 block pb-2 pt-3">
              <a href="/">
                <svg
            ...
            <li className="hover:bg-red-700 block py-2">
              <a href="/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <li className="hover:bg-red-700 block py-3">
              <a href="/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
      ...
      <div className="pl-8 w-8/12 divide-y bg-gray-700 text-gray-100">
