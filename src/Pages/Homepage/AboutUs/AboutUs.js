...
const AboutUs = () => {
     ...
     return (
          <div id='about' style={{ fontFamily: "'Rajdhani', sans-serif" }} className={`${darkMode && "text-white"}  py-16 px-10 sm:px-20`}>
               ...
               <div className='flex capitalize flex-col sm:flex-row'>
                    <div className='w-10/12 sm:w-5/12'>
                         <div className='relative w-full sm:w-9/12 sm:h-[420px] mx-auto  '>
                              ...
                              <div className='flex items-center justify-center flex-col font-semibold text-blaack  bg-warning h-[130px] w-[130px] rounded-full absolute top-[-40px] right-[-40px]'>
                    ...
                    <div className='w-11/12 sm:w-6/12 text-center sm:text-left sm:mt-0 mt-8'>
                         ...
                         <button
                              className='px-8 py-3 border-2 border-red-600 bg-warning hover:bg-white hover:text-teal-900  duration-200 text-black rounded inline-block mt-4 sm:mt-8 font-semibold'>
                              Explore Now
                         </button>
                    </div>
               </div>
