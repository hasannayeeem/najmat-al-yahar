          ...
          <button
            className={`${
              darkMode
                ...
                : "hover:bg-warning bg-white text-teal-900 border border-error hover:text-black"
            } sm:px-7 px-5 transition py-1.5 sm:py-2.5 rounded-[3px] mt-5 uppercase flex justify-center items-center`}
          >
            add review{" "}
            <AiOutlineStar className="ml-2 text-orange-400 hover:text-white block font-bold text-lg" />
          </button>
        </Link>
      </div>
    </div>
