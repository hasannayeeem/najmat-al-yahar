      ...
      <div className="container px-5 pt-24 pb-4 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            {" "}
            subway tile poke farm-to-table. Franzen you probably haven't heard
        ...
        <div className="flex flex-wrap -m-4 text-center">
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className=" px-4 py-6 rounded-lg">
              ...
              >
                <CountUp start={1} end={27.2} duration={5} />K
              </h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="px-4 py-6 rounded-lg">
              ...
              >
                <CountUp start={1} end={4} duration={5} />M
              </h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className=" px-4 py-6 rounded-lg">
              ...
              >
                <CountUp start={1} end={74} duration={4} />K
              </h2>
              <p className="leading-relaxed">Information</p>
            </div>
          </div>
          {/* help statistics */}
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="  px-4 py-6 rounded-lg">
              ...
              >
                <CountUp start={1} end={46} duration={5} />K +
              </h2>
              <p className="leading-relaxed">Commercial Hints</p>
            </div>
          </div>
        </div>
      </div>
