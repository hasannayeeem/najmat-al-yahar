...
const Director = ({director}) => {
  return (
    <div className="bg-white p-5 md:p-10 w-[300px] sm:w-[200px] lg:w-[320px] h-[70vh]  lg:rounded-l-md">
        <img className='m-auto rounded-full border-[#e3cc38] border-[1px] p-[5px]' src={director?.image} alt="" />
