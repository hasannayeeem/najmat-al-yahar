...
const Director = ({director}) => {
  return (
    <div className="bg-white p-5 md:p-10 w-[300px] sm:w-[200px] lg:w-[300px] rounded-md">
        <img className='m-auto rounded-full border-[#e3cc38] border-[1px] p-[5px]' src="https://akij.net/img/Nasir-Sir.png" alt="" />
