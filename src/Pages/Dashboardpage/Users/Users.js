...
const Users = () => {
  ...
  const { isLoading, error, data, refetch } = useQuery(["allUser"], () =>
    fetch("https://neighbour-home--server.herokuapp.com/user").then((res) =>
      res.json()
    )
  );
  ...
  return (
    <div className="sm:px-10 px-2 pb-5">
      <h5
        ...
        } text-lg text-left font-bold  mb-2 `}
      >
        Make Admin
      </h5>
            ...
            {data?.map((user, i) => {
              ...
              return (
                <tr
                  ...
                  className={`${
                    darkMode
                      ? " bg-gray-800 border-gray-700 odd:bg-gray-800 even:bg-gray-700"
                ...
                >
                  <th
                    ...
                    }  px-3 sm:pr-0 sm:pl-8 py-2  sm:py-4 font-medium  whitespace-nowraptext-[13px]`}
                  >
                    {i + 1}
                  </th>
                  ...
                  <td className="py-2 text-[13px] sm:py-4 text-center">
                    {user?.role === "admin" ? (
                      <button
                        onClick={deleteAdmin}
                        className={`${
                          darkMode && "hover:text-white hover:btn-ghost"
